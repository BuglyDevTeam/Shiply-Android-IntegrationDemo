...
public class TestConfigActivity extends Activity {
    ...
    private void getLocalConfig() {
        ...
        String value = ShiplyIntegrationHelper.INSTANCE.getRdeliveryInstance().getStringByKey(key, null, true);
    ...
    private void getLocalSwitch() {
        ...
        boolean value = ShiplyIntegrationHelper.INSTANCE.getRdeliveryInstance().isOnByKey(key, false, true);
    ...
    private void getLocalConfigSwitchData() {
        ...
        RDeliveryData value = ShiplyIntegrationHelper.INSTANCE.getRdeliveryInstance().getRDeliveryDataByKey(key, null, true);
